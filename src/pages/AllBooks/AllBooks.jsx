...
const AllBooks = () => {
    ...
    return (
        <div>
            <div className="mt-10 max-w-sm bg-[#d1bf9c] border-2 border-[#404142] px-2 py-2 flex justify-center items-center mx-auto rounded-full w-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-x-2 gap-y-2 md:gap-y-0 mt-8">
                    <div className="flex gap-x-2 md:gap-x-4 items-center">
                        ...
                        <div className="flex border-2 text-sm md:text-lg border-[#404142] text-[#36383a] items-center font-medium bg-[#C6AD8F] p-2">
                            <Link className="border-r-4 pr-4 border-[#404142] hover:text-white">Available Books</Link>
                    ...
                    <div className="flex gap-x-2 md:gap-x-4 items-center">
                        ...
                        <div className="flex items-center bg-[#C6AD8F] border-2 border-[#404142] gap-x-2 p-2">
                            ...
                            <NavLink 
                                ...
                                className={({ isActive }) =>
                                    isActive ? `text-lg md:text-3xl text-white ${view === "Grid" ?"text-white" : "text-[#404142]"} font-bold hover:tooltip hover:tooltip-open hover:tooltip-bottom` : "text-lg md:text-3xl text-[#404142] font-bold hover:text-white hover:tooltip hover:tooltip-open hover:tooltip-bottom"} 
                                data-tip="Grid View"
                            >
