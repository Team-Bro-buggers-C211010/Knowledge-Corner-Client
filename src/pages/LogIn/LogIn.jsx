                        ...
                        <form onSubmit={handleSignIn} className="card-body">
                            <div className="form-control">
                                ...
                                <select className="select select-bordered text-sm md:text-base text-base-content" onChange={handleRole}>
                                    <option className="text-sm md:text-base" value="User">User</option>
                                    <option className="text-sm md:text-base" value="Librarian">Librarian</option>
                                </select>
                            </div>
                            {
                                role === "Librarian" &&
                                <div className="form-control text-sm md:text-base">
                                    ...
                                    <input name="verification" type="text" placeholder="Enter the code given by Admin" className="input input-bordered text-sm md:text-base" required />
                                </div>
                            }
                            <div className="form-control text-sm md:text-base">
                                <label className="label">
                            ...
                            </div>
                            {
                                role === "User" && <>
                                    ...
                                    <div className="form-control">
                                        <button onClick={handleGoogleSignIn} className="btn bg-[#ea9b25] text-white hover:bg-white text-sm md:text-base hover:border-2 hover:border-[#ea9b25] hover:text-[#FF9800]"><FcGoogle className="h-7 w-7" />Login With Google</button>
                                    </div>
                                </>
                            }
                        </form>
