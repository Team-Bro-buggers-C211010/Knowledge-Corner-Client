                ...
                <Marquee pauseOnHover={true} speed={70}>
                    <div className="ml-5 card card-compact rounded-none w-80 md:w-96 bg-[#d1bf9c] shadow-xl shadow-orange-400">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/category/kids" className="btn bg-[#404142] border-2 border-[#d1c2b2] text-[#d1c2b2] hover:rounded-full hover:bg-transparent hover:text-[#404142] hover:border-[#404142]">Explore more</Link>
                        </div>
                    </div>
                    <div className="ml-5 card card-compact rounded-none w-80 md:w-96 bg-[#d1bf9c] shadow-xl shadow-orange-400">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/category/Comics" className="btn bg-[#404142] border-2 border-[#d1c2b2] text-[#d1c2b2] hover:rounded-full hover:bg-transparent hover:text-[#404142] hover:border-[#404142]">Explore more</Link>
                        </div>
                    </div>
                    <div className="ml-5 card card-compact rounded-none w-80 md:w-96 bg-[#d1bf9c] shadow-xl shadow-orange-400">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/category/Entertainment" className="btn bg-[#404142] border-2 border-[#d1c2b2] text-[#d1c2b2] hover:rounded-full hover:bg-transparent hover:text-[#404142] hover:border-[#404142]">Explore more</Link>
                        </div>
                    </div>
                    <div className="ml-5 card card-compact rounded-none w-80 md:w-96 bg-[#d1bf9c] shadow-xl shadow-orange-400">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/category/Horror" className="btn bg-[#404142] border-2 border-[#d1c2b2] text-[#d1c2b2] hover:rounded-full hover:bg-transparent hover:text-[#404142] hover:border-[#404142]">Explore more</Link>
                        </div>
                    </div>
                    <div className="ml-5 card card-compact rounded-none w-80 md:w-96 bg-[#d1bf9c] shadow-xl shadow-orange-400">
                        <figure className="w-full h-64 md:h-80"><img className="h-full w-full object-fill object-center" src={computer} alt="Shoes" /></figure>
                        <div className="card-body">
                            <h2 className="font-bold md:text-2xl text-[#404142] text-center">Computers</h2>
                            <Link to="/category/Computers" className="btn bg-[#404142] border-2 border-[#d1c2b2] text-[#d1c2b2] hover:rounded-full hover:bg-transparent hover:text-[#404142] hover:border-[#404142]">Explore more</Link>
                        </div>
                    </div>
                    <div className="ml-5 card card-compact rounded-none w-80 md:w-96 bg-[#d1bf9c] shadow-xl shadow-orange-400">
                        <figure className="w-full h-64 md:h-80"><img className="h-full w-full object-fill object-center" src={sci} alt="Shoes" /></figure>
                        <div className="card-body">
                            <h2 className="font-bold md:text-2xl text-[#404142] text-center">Sci-Fiction</h2>
                            <Link to="/category/Sci-Fiction" className="btn bg-[#404142] border-2 border-[#d1c2b2] text-[#d1c2b2] hover:rounded-full hover:bg-transparent hover:text-[#404142] hover:border-[#404142]">Explore more</Link>
                        </div>
                    </div>
                    <div className="ml-5 card card-compact rounded-none w-80 md:w-96 bg-[#d1bf9c] shadow-lg shadow-orange-300">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/category/Social-Science" className="btn bg-[#404142] border-2 border-[#d1c2b2] text-[#d1c2b2] hover:rounded-full hover:bg-transparent hover:text-[#404142] hover:border-[#404142]">Explore more</Link>
                        </div>
                    </div>
                </Marquee>
            </div>
