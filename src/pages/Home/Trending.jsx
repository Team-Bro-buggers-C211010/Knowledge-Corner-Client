...
const Trending = () => {
    return (
        <div className="mt-9 md:mt-14 container mx-auto">
            ...
            <p className="text-center font-montserrat text-base-content md:text-lg mt-3">Check out the must-reads that everyone is talking about.</p>
            <hr className="mt-5 border-2 border-dashed mb-5" />
            <div className="card md:card-side md:h-[500px] lg:h-[400px] rounded-none bg-base-100 shadow-xl mb-10">
                ...
                <div className="card-body md:w-1/2">
                    <div className="border-l-4 pl-5 border-[#f3701d]">
                        <h2 className="card-title text-base-content font-josefin">Library Expands Digital Collection</h2>
                        <h1 className="text-[#f3701d]">More E-books and Audio books Available</h1>
                    </div>
                    <h3 className="pl-5 mt-8 text-base-content font-montserrat">Our library is thrilled to announce the significant expansion of our digital collection, bringing an array of new e-books and audiobooks to our patrons. With this update, accessing your favorite titles and discovering new ones has never been easier. Whether you prefer the convenience of reading on your device or listening to audiobooks on the go, our enhanced digital library offers something for everyone. Explore the latest bestsellers, timeless classics, and an extensive range of genres right from the comfort of your home. Dive into our digital collection today and enjoy an unparalleled reading experience!</h3>
                </div>
            </div>
